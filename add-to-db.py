...
ChineseDict = ['國課','國翰','國文學習單','國習','國文習作','國文','國講','國文講義','國卷','3688國文','國復講','國複講','自學','古文','默書','日日讀','解釋','國','字音字形','成語','文學海洋','情歌心得','仿寫','訪寫','最美的一句話學習單','世說新語','世說','國翰自學','試題寶典','試寶']
GeographyDict = ['地課','地學習單','地翰','地習','地理','地紙講']
HouseThingDict = ['家政','盤子','食材','圍裙','針線','食譜','烹飪']
CivisDict = ['公課','公民學習單','公獎','公習','公講','公民','公民講義','公填','公民填充','公民3688']
SportDict = ['體育']
HistoryDict = ['歷史','歷講','歷史講義','歷卷','歷習','歷3688']
ComputerDict = []
MusicDict = ['音樂','直笛']
